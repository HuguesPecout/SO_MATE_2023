...
[Travail dans le domaine de la **géographie humaine et quantitative**  : collecte, gestion, traitement, enrichissement, analyse (statistique, spatiale, de réseau, textuelle...), représentation graphique et cartographie de **données géographiques hétérogènes** (données conventionnelles, données d'enquête, IGV, webscraping...).]{.big3}
...
[Depuis 2022 : Animateur du groupe d'utilisateur·rices [ElementR](https://elementr.netlify.app/)]{.small2}     
...
[D'avantage spécialiste de la communauté R que du langage informatique. Plus formateur que développeur...]{.big3}
...
# [Quelques packages de représentations graphiques spécifiques à connaître...]{.bigtwo}


## [Visualisation de réseau]{.bigone}
...
## [Visualisation de séquence]{.bigone}

\

###  Package `TraMineR`

  Gabadinho, A. & Ritschard, G. (2013), Searching for typical life trajectories applied to
  child birth histories, In R. Lévy & E. Widmer (eds.), Gendered life courses.  pp. 287-312.
  Vienna: LIT
  
  Gabadinho, A., Ritschard, G., Müller, N. S., & Studer, M. (2011). Analyzing and Visualizing
  State Sequences in R with TraMineR. Journal of Statistical Software, 40(4), 1-37. DOI
...
[Mais aussi `ggwordcloud` et `ggwordcloud2``...]{.bigone}
...
## Export animé (gif, mp4)

Possible  notemment ggplot2 et tmp
...
# [Atelier pratique]{.bigtwo}

## [Présentation du jeu de données]{.bigtwo}
...
->  **2 couches géographiques** au format *shapefile* (.shp) :

- **Les relais de poste**. Couche de **points** géoréférencés.  
- **Les route postales**. Couche de **ligne** géoréférencés.      

-> A 8 dates : 1632, 1708, 1733, 1758, 1783, 1810 et 1833


\

16 couches géographiques caractérisées par des attributs, qui cartographie le réseau des routes de poste en France et son évolution de 1632 à 1833
...
# [Représentation de réseau avec `igraph`]{.bigtwo}

## [Supports pédagogiques]{.bigtwo}
...
# [Cartographie avec `mapsf`]{.bigtwo}
