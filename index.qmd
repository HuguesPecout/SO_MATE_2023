...
[**le package `ggplot2` [@R-ggplot2] est une véritable révolution en matière de représentation graphique, qui dépasse le périmètre de la communauté R**. Ce package :]{.bigtwo}
:::
...
- Ouvre la possibilité de construire des représentations graphiques très diverses et personnalisées.
...
La syntaxe de la grammair graphics a été reprise dans plusieurs langages...
...
ggplot(data = cars, mapping = aes(x = Horsepower, 
                                  y = Miles_per_Gallon,
                                  color = Origin)) +
  geom_point()
...
cartographie, animation, intérativité, type de représentation, application...

Esquisse


![](images/extension_ggplot.png)

## De la Customization avancée

X-Men Characters - Cedric Scherer
...
Best selling Authors - Tania Shapiro
...
::: columns
::: {.column width="50%"}
**De nombreuses palettes sont directement disponibles dans R-base** 
...
Près de 70 (!) packages proposent des palettes...   
